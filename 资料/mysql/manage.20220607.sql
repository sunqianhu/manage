...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COMMENT='字典';
...
CREATE TABLE `menu` (
  ...
  `sort` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='菜单';
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('1', '超级管理员', '全部权限', '1653557735', '1654592256');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('6', '1', '1,2', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '超级管理员', '12345678911', '1', '1653709625', '1654483741', '0');
